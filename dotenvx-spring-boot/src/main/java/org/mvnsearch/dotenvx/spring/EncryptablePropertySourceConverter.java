...
import org.mvnsearch.dotenvx.spring.aop.EncryptableMutablePropertySourcesInterceptor;
import org.mvnsearch.dotenvx.spring.aop.EncryptablePropertySourceMethodInterceptor;
import org.mvnsearch.dotenvx.spring.configuration.EnvCopy;
import org.mvnsearch.dotenvx.spring.wrapper.*;
...
public class EncryptablePropertySourceConverter {
    ...
    public static Class<PropertySource<?>> getPropertiesClass(String className) {
        try {
            ...
            throw new IllegalArgumentException(String.format("Invalid dotenvx.encryptor.skip-property-sources: Class %s does not implement %s", className, PropertySource.class.getName()));
        } catch (ClassNotFoundException e) {
            throw new IllegalArgumentException(String.format("Invalid dotenvx.encryptor.skip-property-sources: Class %s not found", className), e);
        }
    }
